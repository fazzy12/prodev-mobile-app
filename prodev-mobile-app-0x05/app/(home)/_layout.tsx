  ...
  return (
    <Tabs screenOptions={{
      ...
      <Tabs.Screen name="saved" options={{
        ...
        title: 'Profile',
        headerShown: true,
        // NOTE: The original instruction used "black" here, but for consistency with color-changing tabs,
        // it should use the color prop, or be wrapped in a view. Sticking to instructions provided.
